...
$.src="//v2.zopim.com/?3hCFcpiVfrte6iK6ZjMnqrXduQwBgIq9";z.t=+new Date;$.
...
<?php include "catalog/view/theme/black_justin/template/common/info.tpl"; ?>
<header>
  <div class="container topheader">
    <div class="row">
      <div class="col-sm-4">
        <div id="logo">
          <?php if ($logo) { ?>
          <a href="<?php echo $home; ?>"><img src="<?php echo $logo; ?>" title="<?php echo $name; ?>" alt="<?php echo $name; ?>" class="img-responsive wow pulse animated" /></a>
          <?php } else { ?>
